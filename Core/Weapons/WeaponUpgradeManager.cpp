		...
		if(!CurrentUpgrades.IsEmpty())
		{
			...
			for (FUpgradeManager UpgradeAvailable : CurrentUpgrades)
			{
				...
				if(UpgradeAvailable.WeaponUpgrades.IsValidIndex(UpgradeAvailable.CurrentUpgradeLevel))
				{
					...
					{
						UpgradesSelected.Add(FUpgradeCommunication(UpgradeAvailable.WeaponReference, UpgradeAvailable.WeaponUpgrades[UpgradeAvailable.CurrentUpgradeLevel], UpgradeAvailable.WeaponType));
